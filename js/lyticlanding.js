...
(function(/*! Stitch !*/) {
...
}, "classes/controllers/Content": function(exports, require, module) {(function(){
...
}, "classes/controllers/Navigation": function(exports, require, module) {(function(){
  var NavigationController;
  NavigationController = (function(superclass){
    var prototype = extend$((import$(NavigationController, superclass).displayName = 'NavigationController', NavigationController), superclass).prototype, constructor = NavigationController;
    function NavigationController(scope, runtime){
      var this$ = this instanceof ctor$ ? this : new ctor$;
      this$.scope = scope;
      this$.runtime = runtime;
      this$.configScope = bind$(this$, 'configScope', prototype);
      this$.initRuntime = bind$(this$, 'initRuntime', prototype);
      this$.initRuntime().configScope();
      return this$;
    } function ctor$(){} ctor$.prototype = prototype;
    prototype.initRuntime = function(){
  ...
  ScrollController = (function(superclass){
    ...
    function ScrollController(scope, runtime){
      var this$ = this instanceof ctor$ ? this : new ctor$;
      this$.scope = scope;
      this$.runtime = runtime;
      this$.configScope = bind$(this$, 'configScope', prototype);
  ...
  SignupController = (function(superclass){
    ...
    prototype.initRuntime = function(){
      ...
      DBStorage.get("signedup", function(data){
        ...
        return $('.flow.prime').addClass('signedup');
      });
...
}, "classes/libs/1974584_10202009495172151_1298727819_n": function(exports, require, module) {if (!window.imagePackage) window.imagePackage = function() { return "data:" + this.mime + ";base64," + this.content };
if (!window.otherImports) window.otherImports = {}; 
var item = {
	mime: 'image/jpeg', 
	content: ''
};
item.toString = function() { return window.imagePackage.apply(item, []); }
return window.otherImports['1974584_10202009495172151_1298727819_n'] = module.exports = item; }, "classes/libs/angular.min": function(exports, require, module) {/*
 AngularJS v1.2.12
...
}).call(this);}, "classes/libs/heatmap": function(exports, require, module) {/*
...
var item = JSON.parse("Get Invited to the Beta:Fi invitat să participi la Beta\nSign Up:Trimite", function(key, value) { var v; try { v = eval(value) } catch(e) { v = value } return v;}); 
return window.JSONImport['ro-RO'] = module.exports = item;}, "data/views/index": function(exports, require, module) {module.exports = function(__obj) {
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "data/views/partials/contactform": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      __out.push('<section class="form" ng-class="{true: \'active\', false: \'inactive\'}[runtime.props[\'contact-form-open\']]">\n    <span class="info" ng-class="error.type">{{error.message}}</span>\n    <label for="name">\n        <i class="fa fa-person"></i><span class="text">Your Name</span>\n        <input type="text" id="name" ng-model="mail.name"/>\n    </label>\n    <label for="mail">\n        <i class="fa fa-at-sign"></i><span class="text">Your eMail Address</span>\n        <input type="email" id="mail" ng-model="mail.email"/>\n    </label>\n    <label for="content">\n        <i class="fa fa-comment"></i><span class="text">The content of your email</span>\n        <textarea id="mail" ng-model="mail.content" cols="30" rows="10"></textarea>\n    </label>\n    <button class="submit" ng-disabled="mail.content.length * mail.email.length" ng-click="alert(\'DONE\')">Submit</button>\n</section>\n');
  ...
  (function() {
    (function() {
      ...
      __out.push(' <small>&lt;TIME&gt;</small></h1>\n    <nav ng-controller="Navigation">\n        <div class="facebook"><a href="#"><i class="fa fa-fw fa-facebook"></i><span>Facbook</span></a></div>\n        <div class="twitter"><a href="http://twitter.com/lyticapp"><i class="fa fa-fw fa-twitter"></i><span>Twitter</span></a></div>\n        <div class="admin"><a href="http://lytic.io/"><i class="fa fa-fw fa-user"></i><span>App</span></a></div>\n        <div class="contact" ng-click="runtime.set(\'contact-form-open\', !runtime.props[\'contact-form-open\'])"><i class="fa fa-fw fa-envelope"></i><span>Contact</span></div>\n        ');
    
      __out.push(DepMan.render(["partials", "contactform"]));
...
@Version          : 0.0.1
@Date Compiled    : Sat Mar 15 2014 02:40:04 GMT+0000 (GMT)
**/
